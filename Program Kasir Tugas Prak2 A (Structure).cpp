//m. sariful huda 20051397049 2020A D4 manajemen informatika//
#include <cstdio>
#include <stdlib.h>
#include <string.h>
#include <iostream>
...
int main (){
	...
	cout << "      Selamat Datang di Toko Swalayan \t" << endl;
	cout << "----------------------------------------- \n\n";
	...
	system ("cls");
		cout<<endl;
	cout << "TOKO SWALAYAN"<<endl;
	cout << "Jln. Sudirman 69 Kediri"<<endl;
	cout << "\n \n";
